...
fig1.tight_layout()
fig1.savefig("Group2_2026/plots/wind_daily.png", dpi=150, bbox_inches="tight")
...
if "month" in final_df.columns:
    ...
    fig2.tight_layout()
    fig2.savefig("Group2_2026/plots/wind_monthly_comparison.png", dpi=150, bbox_inches="tight")
